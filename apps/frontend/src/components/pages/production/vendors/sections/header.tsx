...
const Header = ({ addPage = false, editPage = false, detailsPage = false, vendor, onDelete, onPaymentRequest }: HeaderProps) => {
        ...
        <div className="flex flex-row sm:items-center sm:justify-between gap-4">
            {/* {addPage &&
                ...
                <div className="flex-1 min-w-0">
                    <h1 className="text-xl font-bold text-gray-900 truncate">Add Vendor</h1>
                </div>
            </div>
            } */}
            {detailsPage &&
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <Badge className="text-xs font-medium text-white border-0 rounded-full px-2.5 py-0.5" 
                                       style={{ backgroundColor: vendor?.location?.color || '#67A3F0' }}>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            <p className="text-xs text-gray-500">
                                Last updated: {formatLastUpdated(vendor?.updated_at || vendor?.created_at || '')}
                            </p>
                            {onPaymentRequest && (
                            <Button 
                                variant="outline" 
            ...
            {/* {editPage &&
                ...
                <div className="flex-1 min-w-0">
                    <h1 className="text-xl font-bold text-gray-900 truncate">Edit Vendor</h1>
                </div>
            </div>
            } */}
        </div>
