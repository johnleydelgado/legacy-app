...
export function FactoryAdditionalFields({ notes }: Props) {
  const { register, setValue } = useFormContext<FactoryForm>();
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <Textarea
          id="notes"
          placeholder="Add any additional information about this factory"
