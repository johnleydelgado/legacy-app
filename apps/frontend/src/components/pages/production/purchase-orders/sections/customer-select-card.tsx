...
import { Plus, SquarePen, Search, X, User, Mail, Phone, Loader2, Users, Building2, Contact, Dot, MailIcon, PhoneIcon, Smartphone, UserPlus, CirclePlus } from 'lucide-react';
...
import { useInfiniteUnifiedSearch, useInfiniteCustomers } from '@/hooks/useCustomers2';
...
const CustomerSelectCard: React.FC<CustomerSelectCardProps> = ({
    selectedCustomer,
    showSearch,
    onShowSearchChange,
    onCustomerSelect,
