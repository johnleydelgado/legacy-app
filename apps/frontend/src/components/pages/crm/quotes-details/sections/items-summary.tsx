...
export interface QuotesSummaryTypes {
...
interface ComponentsProps extends QuotesSummaryTypes{
    data?: QuoteTotals;
    refetch?: () => void | Promise<QueryObserverResult<QuoteTotals, Error>>;
}
    ...
    return (
        <div className="bg-white text-gray-800 p-6 rounded-md shadow-md w-full border border-gray-100">
            <div className="flex items-center mb-6">
                ...
                <h2 className="text-xl font-semibold text-gray-800">Quote Summary</h2>
            </div>
            ...
            <div className="space-y-3 mb-4 flex flex-col items-end">
                ...
                {/*    <span className="text-sm font-medium">{formatCurrency(feesTotal)}</span>*/}
                {/*</div>*/}
