...
import {OrderTotals} from "../../../../../services/orders-items/types";

export interface OrdersSummaryTypes {
...
interface ComponentsProps extends OrdersSummaryTypes{
    data?: OrderTotals | null;
    refetch?: () => void | Promise<QueryObserverResult<OrderTotals, Error>> | Promise<void>;
}
