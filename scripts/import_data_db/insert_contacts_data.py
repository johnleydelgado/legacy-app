...
def import_data_file(param_data_fn: str):
    try:
        ...
        for index, data_row in enumerate(content_data):
            ...
            if fk_customer_id != -1:
                normalize_data.append((
                    ...
                    data_row[1],            # Firstname
                    data_row[2],            # Lastname
                    data_row[4],            # Email
                    data_row[5],            # Phone Number
                    "",                     # Mobile Number
                    data_row[3],            # Position Title
                    "OTHER",                # Contact Type
        ...
        columns = ["fk_customer_id", "first_name", "last_name", "email", "phone_number", "mobile_number",
                   "position_title", "contact_type", "created_at", "updated_at"]
        ...
        # region
        sql_query = f"INSERT INTO Contacts ({columns_str}) VALUES ({columns_clause_str})"
